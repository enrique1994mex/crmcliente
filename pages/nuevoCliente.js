...
const NuevoCliente = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            nombre: Yup.string().required('El nombre del clientes es obligatorio'),
            apellido: Yup.string().required('El apellido del clientes es obligatorio'),
            empresa: Yup.string().required('El campo empresa es obligatorio'),
            email: Yup.string().email('Email no válido').required('El email del clientes es obligatorio')
        }),
